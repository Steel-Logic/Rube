...
public class Level4CameraSwapScript : MonoBehaviour {
	...
	public HasPlayerFinishedTeleport script4;
	public HasPlayerFinishedTeleport script5;
	...
	void Update () {
		if (Input.GetKeyDown (KeyCode.T)) {
			if ((script.PlayerFinishedTeleport == true)&&(script2.PlayerFinishedTeleport == true)&&(script4.PlayerFinishedTeleport == true)&&(script5.PlayerFinishedTeleport == true)) { 
